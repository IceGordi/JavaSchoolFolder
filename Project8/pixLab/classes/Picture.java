...
public class Picture extends SimplePicture 
{
  ...
  public void mirrorHorizontal()
  {
    ...
    for (int row = 0; row < pixels.length/2; row++)
    {
      for (int col = 0; col < pixels[0].length-1; col++)
      {
        ...
        secondPixel = pixels[pixels.length-1-row][col];
  ...
  /** Method that mirrors the picture around the diagonal */
  ...
  public void mirrorArms()
  {
    ...
    for (int row = 172; row < 197; row++)
    {
      ...
      for (int col = 239; col < 293; col++)
      {
        ...
        firstPixel = pixels[row][col];
        secondPixel = pixels[row+69][col+6];
        secondPixel.setColor(firstPixel.getColor());
      }
    }
      for (int row = 158; row < 192; row++)
    {
      ...
      for (int col = 104; col < 171; col++)
      {
        ...
        firstPixel = pixels[row][col];
        secondPixel = pixels[row+69][col-8];
        secondPixel.setColor(firstPixel.getColor());
      }
    }
  }
 ...
 /** Mirror just part of a picture of a seagull */
  public void mirrorGull()
  {
    ...
    for (int row = 235; row < 321; row++)
    {
      ...
      for (int col = 239; col < 344; col++)
      {
        ...
        firstPixel = pixels[row][col];
        secondPixel = pixels[row][col+125];
        secondPixel.setColor(firstPixel.getColor());
      }
    }
  }
  ...
  //Method to eliminate all green and red values of a picture
  ...
  public void grayscale(){
    ...
    Pixel[][] pixels = this.getPixels2D();
     for (Pixel[] rowArray : pixels)
     {
       for (Pixel pixelObj : rowArray)
       {
        value = (pixelObj.getRed() + pixelObj.getGreen() + pixelObj.getBlue())/3;
  ...
  //Method to fixUnderwater image and show fish more clearly
